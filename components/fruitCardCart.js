  ...
  return (
    <View className="flex-row justify-between items-center space-x-5 mb-4">
      ...
      <View className="flex-row items-center space-x-2">
        <TouchableOpacity className="bg-gray-300 p-1 rounded-lg" onPress={incrementQuantity}>
          <PlusIcon size="15" color="white" />
        </TouchableOpacity>
        <Text>{quantity}</Text>
        <TouchableOpacity className="bg-gray-300 p-1 rounded-lg" onPress={decrementQuantity}>
