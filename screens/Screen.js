...
import ButtonGradient from '../Botones/ButtonGrandiet';
import Buton2 from '../Botones/Buton2';
  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.container}>
        <Text style={styles.titulo}>Programin</Text>
        <Text style={styles.tituloo}>Store🤪</Text>
        <Text style={styles.subTitle}>Only Developers</Text>
       
      
        
        <ButtonGradient/>
        <Text style={styles.forgotPassword}>lOrl</Text>
